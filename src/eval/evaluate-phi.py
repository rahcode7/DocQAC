...
# op_file = os.path.join(DATA_PATH,"metrics","eval_phi_1.csv")


MODEL_LIST = ['title_url_rag_dense','title_url_rag_sim_doc','title_url_rag_sparse']
op_file = os.path.join(DATA_PATH,"metrics","eval_phi_2.csv")
