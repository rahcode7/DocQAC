...
def get_args():    
    ...
    parser.add_argument('--model_name', type=str, default="bart-base")
...
def main(args):
    ...
    if(args.wandb and accelerator.is_main_process):
        ...
        wandb.init(project="Bart-autocompletion", name=args.model_dir)
    else:
        wandb.init(project="Bart-autocompletion", name=args.model_dir, mode="disabled")
