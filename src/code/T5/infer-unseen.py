...
from utils_tau import AutocompleteDataset, merge_prefix_suffix, prefix_encoder, suffix_decoder, suffix_encoder, AdaptiveSoftTrieProcessor, TokenPrefixSuffixTrie
import time
...
if __name__ == '__main__':
    ...
    parser.add_argument("--alpha", type=float, default=0.3, help="Alpha value for the AdaptiveSoftTrieProcessor")
    parser.add_argument("--beta", type=float, default=0.1, help="Beta value for the AdaptiveSoftTrieProcessor")
    parser.add_argument("--bias_strength", type=float, default=30, help="Bias strength for the AdaptiveSoftTrieProcessor")
        ...
        for batch in tqdm.tqdm(data_loader):
            ...
            if args.use_trie:
                if isinstance(token_trie, dict):
                    ...
                    the_trie = [token_trie]
                logit_processor = AdaptiveSoftTrieProcessor(
                    the_trie,
                    inp_prefix,
                    tokenizer,
