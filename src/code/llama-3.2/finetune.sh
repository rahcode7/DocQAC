...
# Llama model have restricted access, please get access from HF and paste your profile HF_token here 
...
do
    ...
    rm -f ${log_dir}/${full_model_name}.log;accelerate launch --multi_gpu --num_processes 8 llama_32_script.py \
